...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.temp.seckill_id = this.$route.query.seckill_id
      if (this.$route.name === 'seckill-goods-add') {
        this.modiType = 'add'
      } else {
        this.modiType = 'edit'
        this.temp.goods_id = this.$route.query.goods_id
        api.seckill_goods_detail({
    ...
    methods: {
      ...
      submit() {
        if (this.modiType === 'add') {
          this.m_submits(this.modiTosendData(), 'seckill_goods_create', (res) => {
            this.$message({
              message: res.info,
              type: '',
            })
          ...
          this.m_submits(this.modiTosendData(), 'seckill_goods_edit', (res) => {
            this.$message({
              message: res.info,
              type: '',
            })
      ...
      */
      ...
      selGoods(row) {
        ...
        if (this.temp.type == 'normal') {
          this.temp.goods_image = this.selGoodsData[this.temp.type].goods_image
